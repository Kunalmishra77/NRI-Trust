...
export default function NotFound() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[50vh] bg-gradient-to-b from-accent/5 to-transparent pointer-events-none blur-3xl opacity-50" />
