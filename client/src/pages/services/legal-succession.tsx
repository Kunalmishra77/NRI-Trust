          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative">
              <div className="aspect-[4/5] rounded-[3rem] overflow-hidden border border-white/10 shadow-3xl">
                <img src="/attached_assets/image_1764305837111.png" alt="Succession planning" className="w-full h-full object-cover grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-1000" />
              </div>
