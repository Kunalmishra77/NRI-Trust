            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="aspect-square glass-panel rounded-3xl border-white/10 overflow-hidden relative">
                  <img src="/attached_assets/image_1764308005552.png" alt="Inspection" className="w-full h-full object-cover grayscale" />
                </div>
                <div className="aspect-square glass-panel rounded-3xl border-white/10 overflow-hidden relative mt-12">
                  <img src="/attached_assets/image_1764308558151.png" alt="Maintenance" className="w-full h-full object-cover grayscale" />
                </div>
              </div>
            </div>
          </div>
