          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={luxuryStagger} className="relative group">
              <div className="aspect-video rounded-3xl overflow-hidden border border-white/10 relative shadow-2xl mb-8">
                <img src="/When Timezones.png" alt="Emergency Resolution" className="w-full h-full object-cover grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000" />
      ...
      <section className="section-padding bg-background relative overflow-hidden border-t border-white/[0.05]">
        ...
        <div className="max-container text-center relative z-10">
          ...
          >
            ...
            {/* Trust Badges in CTA */}
            <div className="mt-32 pt-12 border-t border-white/[0.05] flex flex-wrap items-center justify-center gap-12 lg:gap-20 opacity-40 hover:opacity-100 transition-opacity duration-700">
              <div className="flex items-center gap-3">
