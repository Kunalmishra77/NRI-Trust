   ...
   <div className="max-container flex items-center justify-between">
    ...
    <div className="hidden lg:flex items-center gap-10 xl:gap-12">
     {navLinks.map((nav) => (
      ...
      >
       <button className={`font-sans text-[18px] lg:text-[20px] font-semibold flex items-center gap-2 transition-all ${
        activeDropdown === nav.id || location.includes(nav.id) ? "text-accent scale-105" : "text-white/90 hover:text-white"
       }`}>
        {nav.label}
