      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-[20] w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white leading-[1.06] tracking-tight">
                Is Your Parent's
              </div>
        ...
        >
          {STATS.map((s) => (
            <div key={s.label} className="flex items-baseline gap-3">
              ...
              <div className="text-[11px] text-white/40 font-bold tracking-[0.15em] uppercase whitespace-nowrap">{s.label}</div>
            </div>
          ))}
        </motion.div>
      </div>
