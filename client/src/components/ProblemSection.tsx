    ...
    <section id="problems" className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="max-container relative z-10">
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-center mb-32">
          ...
          >
            <div className="aspect-[4/3] rounded-[3rem] overflow-hidden border border-white/10 shadow-3xl grayscale hover:grayscale-0 transition-all duration-1000 group">
              <div className="absolute inset-0 bg-red-500/10 mix-blend-overlay z-10" />
              <img src="/attached_assets/image_1764305837111.png" alt="Family heritage risks" className="w-full h-full object-cover opacity-60 group-hover:opacity-100" />
              <div className="absolute top-8 left-8 flex items-center gap-3 bg-red-500/20 border border-red-500/40 px-4 py-2 rounded-full backdrop-blur-md z-20">
