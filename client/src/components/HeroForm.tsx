      ...
      <div className="bg-white/5 backdrop-blur-3xl border border-white/10 p-5 md:p-6 rounded-[1.5rem] shadow-2xl relative overflow-hidden">
        ...
        <form className="space-y-3 relative z-10" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="relative group">
            <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-300 ${focused === 'name' ? 'text-[#d4af37]' : 'text-white/20'}`}>
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg py-2.5 pl-10 pr-3 text-[12px] text-white font-medium outline-none focus:border-[#d4af37]/40 focus:bg-white/10 transition-all duration-300 placeholder:text-white/20"
            />
          </div>

          {/* Email Input */}
          <div className="relative group">
            <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-300 ${focused === 'email' ? 'text-[#d4af37]' : 'text-white/20'}`}>
          ...
          {/* WhatsApp Number */}
          <div className="relative group">
            <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-300 ${focused === 'whatsapp' ? 'text-[#d4af37]' : 'text-white/20'}`}>
          ...
          {/* Service Interest */}
          <div className="relative group">
            <div className={`absolute left-3.5 top-3 transition-colors duration-300 ${focused === 'message' ? 'text-[#d4af37]' : 'text-white/20'}`}>
            ...
            <textarea
              ...
              onBlur={() => setFocused(null)}
              className="w-full bg-white/5 border border-white/10 rounded-lg py-2.5 pl-10 pr-3 text-[12px] text-white font-medium outline-none focus:border-[#d4af37]/40 focus:bg-white/10 transition-all duration-300 placeholder:text-white/20 resize-none"
            />
          </div>
        ...
        <div className="mt-5 flex items-center justify-center gap-2">
          ...
          <span className="text-[9px] font-mono font-bold uppercase tracking-[0.2em] text-white/30 leading-none">Your Information Is Handled Securely</span>
        </div>
      </div>
    </motion.div>
  );
