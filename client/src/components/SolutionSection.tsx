              ...
              <div className={`lg:col-span-6 ${index % 2 !== 0 ? "lg:order-1" : ""}`}>
                <div className="relative group perspective-container">
                  ...
                  >
                    ...
                    <div className="aspect-[4/3] rounded-[3rem] overflow-hidden border border-white/5 bg-[#0A0F0D] shadow-3xl">
                      <div className="absolute inset-0 bg-gradient-to-tr from-[#050806] via-transparent to-transparent z-10" />
                      <div className="absolute inset-0 bg-noise-overlay opacity-20 pointer-events-none z-10" />
