...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#FDFCFB] text-[#1A1A1A] relative overflow-hidden border-t border-black/[0.05] z-20">
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10 pt-10 pb-6">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 mb-8">
          ...
          <div className="lg:col-span-4 flex flex-col">
            <Link href="/" className="flex items-center gap-4 mb-6 group w-fit">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[12px] font-mono tracking-[0.3em] uppercase text-accent mt-1 font-bold">Financial Protection</span>
              </div>
            </Link>

            <p className="text-lg text-[#1A1A1A]/90 font-medium mb-6 max-w-sm leading-relaxed">
            ...
            <div className="space-y-4 mb-8">
              <a href="mailto:advisory@nritrust.com" className="flex items-center gap-4 group text-[#1A1A1A]/80 hover:text-accent transition-colors">
                ...
                <span className="font-mono text-[14px] font-bold tracking-wider">advisory@nritrust.com</span>
              </a>
              <a href="tel:+919876543210" className="flex items-center gap-4 group text-[#1A1A1A]/80 hover:text-accent transition-colors">
                ...
                <span className="font-mono text-[14px] font-bold tracking-wider">+91 98765 43210</span>
              </a>
            </div>
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-8 pt-2">
            {Object.entries(footerLinks).map(([title, links]) => (
              <div key={title}>
                <h3 className="font-mono text-[13px] font-black uppercase tracking-[0.3em] text-accent mb-8">{title}</h3>
          ...
          <div className="lg:col-span-3 flex flex-col pt-2">
            <h3 className="font-mono text-[13px] font-black uppercase tracking-[0.3em] text-accent mb-8">Client Access</h3>
            
            <Link href="/portal">
              <motion.div 
                whileHover={{ y: -5, borderColor: "rgba(212,175,55,0.4)" }}
                className="p-6 rounded-[2rem] border border-[#1A1A1A]/10 bg-white transition-all cursor-pointer group mb-8 shadow-xl shadow-black/[0.02]"
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <div className="text-[14px] font-mono font-black text-[#1A1A1A] uppercase tracking-widest leading-none mb-1">Client Portal</div>
                    <div className="text-[12px] text-accent font-bold uppercase tracking-tight">Secure Access</div>
                  </div>
                </div>
                <div className="flex items-center justify-between text-[11px] font-mono text-[#1A1A1A]/70 uppercase tracking-widest group-hover:text-accent transition-colors">
            ...
            <div className="p-6 rounded-2xl bg-[#1A1A1A]/5 border border-[#1A1A1A]/5 space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-mono text-[#1A1A1A]/75 uppercase font-bold">Status</span>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-green-600 animate-pulse" />
                  <span className="text-[12px] font-mono text-green-600 font-black uppercase">Live</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-mono text-[#1A1A1A]/75 uppercase font-bold">HQ</span>
                <span className="text-[13px] font-mono text-[#1A1A1A] font-black uppercase">Mumbai</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-black/[0.05] flex flex-col md:flex-row justify-between items-center gap-4 md:gap-8">
          <span className="text-[14px] font-mono text-[#1A1A1A]/80 tracking-[0.15em] uppercase font-black">
            &copy; {currentYear} NRI Trust Global Advisory Ltd.
          </span>

          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            <div className="flex items-center gap-6">
              <Link href="/terms" className="text-[13px] font-mono font-bold uppercase tracking-widest text-[#1A1A1A]/75 hover:text-accent transition-colors">Terms</Link>
              <Link href="/privacy" className="text-[13px] font-mono font-bold uppercase tracking-widest text-[#1A1A1A]/75 hover:text-accent transition-colors">Privacy</Link>
            </div>

            <div className="hidden md:block h-4 w-px bg-black/10" />

            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3 text-[13px] font-mono text-[#1A1A1A]/75 uppercase tracking-widest font-black">
